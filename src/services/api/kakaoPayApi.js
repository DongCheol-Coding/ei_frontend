...
/*
[변경 요약]
- 모바일 드롭다운 메뉴의 Link → NavLink로 변경, isActive에 따른 스타일 적용.
- 모바일의 "마이페이지/관리자페이지" 항목도 NavLink로 변경(관리자 여부에 따라 경로 분기).
- 모바일 "로그아웃"은 Link → button으로 교체(의도치 않은 라우팅 방지).
*/
      ...
      <div className="container max-w-8xl mx-auto px-10">
        <div className="flex items-center justify-between h-[54px]">
          ...
          <div className="flex-shrink-0 flex items-center space-x-2">
            ...
            <div className="flex flex-col mx-4">
              <span className="text-xs font-bold text-blue-700">부트캠프 압도적</span>
              <span className="text-xs font-bold text-blue-700">1위의 책임감*</span>
            </div>
          </div>
        ...
        {open && (
          <>
            ...
            {/* 패널 */}
            <div
              className="lg:hidden absolute right-0 top-full w-[200px] bg-white border border-gray-200 rounded-md shadow-xl z-50"
              role="menu"
