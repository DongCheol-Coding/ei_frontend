  ...
  return (
    <div className="flex items-center justify-center p-20 ">
      <div className="bg-[#fefee1] border border-gray-200 shadow-sm p-5 w-full max-w-[400px]">
        ...
        <button
          type="button"
          className="w-full text-[18px] text-gray-500 font-bold mt-8 py-3 border border-gray-300 rounded-lg hover:bg-[#fcfcce] transition flex items-center justify-center cursor-pointer"
